...
const SelectCardForm: React.FC<IProps> = ({
  requiredEmail,
  formValues,
  formErrors,
  setFieldValue,
  ...
  return (
    <>
      {isTermsVisible && (
        <LinkModal
          source={'https://postpay.io/terms'}
          onClose={() => setTermsVisible(false)}
        />
      )}
      {isPrivacyVisible && (
        <LinkModal
          source={'https://postpay.io/privacy'}
      ...
      <CheckoutLayoutContent
        footerElement={
          <SubmitButtonWrapper>
            <PolicyText>
              <Trans
                i18nKey="byClickingOnThePaymentButton"
                components={[
                  <a
                    onClick={() =>
                      openTermsInNewTab('https://postpay.io/terms')
                    }
                  ></a>,
                  <a
                    onClick={() =>
                      openPrivacyInNewTab('https://postpay.io/privacy')
                    }
                  ></a>,
                ]}
              />
